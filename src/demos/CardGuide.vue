<template>
  <div class='guide'>
    ...
    <div class="wal_gouka_tip">
      ...
      <div class="wal_gouka_box">
        <p>1.如果您是企业客户，除了可以亲临噼啪实体门店购物买实体礼品卡，还可以足不出户购买电子礼品卡，我们将根据企业提供的信息提供专属的领卡方案。</p>
        ...
        <p>噼啪确认订单后，单位按照付款通知列明的账户信息付款，仅接受与申请单位同名的银行账户转账。付款后将付款凭证发送给 <span class="wal_cblue">CNFS@wal-mart.com。</span>
        </p>

        <p class="wal_txt_p2">3.交付与分发</p>

        <p>噼啪收到款项审核无误后，将会于客户核对资料，将电子卡领取方式发给企业。</p>
      ...
      <div class="wal_gouka_box">
        <p>1.噼啪可以根据企业的个性化需求提供自定义卡面服务等。</p>
        <p>2.噼啪可以根据企业的需求，创建领卡人验证信息。 </p>
      </div>

      <p class="wal_txt_p1">四.其他资料</p>
      <div class="wal_gouka_box">
        <p>1.与噼啪实体门店购卡相同，噼啪对单位客户购卡达到指定金额提供折扣。折扣比率如下：</p>
        <p class="wal_txt_img"><img src="../assets/images/tips_05.png" alt=""></p>
        <p>2.单卡面值：5-1,000元，任意金额。</p>
        <p>3.发票：提供增值税普通发票，发票由“深圳噼啪百货零售有限公司”开具，发票内容可以为“商品一批”、“食品一批”或者“日用品一批”，购卡折扣金额将会明示在发票上。</p>
        <p>4.如果顾客需要购卡协议，噼啪可以提供标准版本的协议。</p>
        <p>5.如果顾客有任何疑问，可以发送邮件至 <span class="wal_cblue">CNFS@wal-mart.com</span> 咨询。</p>
        <p>6.使用过程中有任何疑问，可以拨打4000-888-400进行咨询。</p>
        <p>7.未尽事宜，请参考《电子卡指引》和《噼啪GIFT卡章程》。</p>
      </div>
    </div>
  </div>
</template>
