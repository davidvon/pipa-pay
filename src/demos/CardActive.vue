<template>
  <div class="order-result">
    <x-header :left-options='{showBack:true, backText:"返回"}' :right-options="{showMore:true}" @on-click-more="showMenus=true">激活会员卡</x-header>
    ...
    <div id="result-page" class="flex">
      <div class="content trade_success" v-show="active_status==0">
        ...
        <p class="card_pbtn"><x-button type="primary" @click="clickMemCard">查看电子卡</x-button></p>
      </div><!-- content end -->
