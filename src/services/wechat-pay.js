function _wechatPay(orderid, data, success, error) {
...
*/
export function wechatPay(http, orderid, paytype, success, error) {
  ...
  http.post('/api/order/payable?orderid=' + orderid + '&paytype=' + paytype,
    function (data) {
      if (data.result == '0') return _wechatPay(orderid, data.content, success, error);
